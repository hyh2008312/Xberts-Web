      ...
      $scope.submitForm = function(address, ev) {
        ...
        $mdDialog.show(
          $mdDialog.alert()
            ...
            .textContent("The product will be shipped within 5 working days. You will receive an email notification once the item is shipped." +
              " If you have any question, please contact us at support@xberts.com!")
            .ariaLabel('Alert Dialog')
            .ok('Got It')
            .targetEvent(ev)
            .disableParentScroll(true)
