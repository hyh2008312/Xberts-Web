      ...
      function User(userId, firstName, lastName, userEmail, userType, userAvatar, isLinkedinSignup, isLinkedinConnected,
        ...
        this.authRequired = function(obj,ev) {
          if (this.isAuth()) {
            ...
            var _dialogSrc = 'scripts/feature/login/login.html';
            if($mdMedia('xs')) {
              _dialogSrc = 'scripts/feature/login/login-mobile.html';
            }
            $mdDialog.show({
              controller: function(scope, $mdDialog) {
                ...
                scope.loginDialogMobile = false;

                scope.showLogin = function() {
                  scope.loginDialogMobile = !scope.loginDialogMobile;
                };

                scope.signupDialogMobile = false;

                scope.showSignup = function() {
                  scope.signupDialogMobile = !scope.signupDialogMobile;
                };

              },
              templateUrl: _dialogSrc,
      ...
      function loginRedirect() {
        ...
        if ($rootScope.postLoginState) {
          if($rootScope.postLoginState.state == 'application.askQuestionMain.answerQuestionDetail'
            || $rootScope.postLoginState.state == 'application.productDeals.dealsDetail') {
